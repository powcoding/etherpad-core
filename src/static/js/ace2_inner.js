...
function Ace2Inner(){
  ...
  var editorInfo = window.editorInfo;
  ...
  function incorporateUserChanges(isTimeUp)
  {
    ...
    {
      //产生cs，把cs合并到Y上，更新rep.alines，更新rep.alltext
  ...
  function doRepApplyChangeset(changes, insertsAfterSelection)
  {
    ...
    {
      window.console.log(JSON.stringify(rep));
  ...
  */
  ...
  function toggleAttributeOnSelection(attributeName)
  {
    ...
    //用来判断apool的value是true还是空值（即false）
  ...
  this.init = function () {
    $(document).ready(function(){
      ...
      inCallStack("setup", function()
      {
        ...
        var body = $('#editorcontainer').children('.w-e-text')[0];
